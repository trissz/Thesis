document.addEventListener('DOMContentLoaded', async function() {
    ...
    const form = document.getElementById("select_based_task_create_form");
    ...
    maxSelectionsInput.value = selectBasedTaskDataset.defaultMaxSelections;
    const selectableElementsHandler = SelectableElementsHandler([], maxSelectionsInput.value);
    ...
    function addOption(optionText, container)
    {
        ...
        removeOptionElementButton.addEventListener("click", (event) => {
